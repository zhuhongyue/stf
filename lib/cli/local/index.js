...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('automation_path', {
      describe: 'The iPATH folder path.'
    , type: 'string'
    , default: '//tests.py'
    })
    .option('automation_default_config', {
      describe: 'The iPATH config folder path.'
    , type: 'string'
...
module.exports.handler = function(argv) {
  ...
  function run() {
    process.env.testpath = argv.automation_path
    process.env.testpath_default_config = argv.automation_default_config
    var procs = [
      // app triproxy
